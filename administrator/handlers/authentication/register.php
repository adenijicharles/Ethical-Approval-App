<?php
    ...
    if($_POST){
        ...
        $check = $connection->prepare('SELECT * FROM administrators WHERE staff_id = :staff_id OR email = :email');
        ...
        // create user account 
        $query = $connection->prepare('INSERT INTO administrators (name, email, staff_id, password) VALUES (:name, :email, :staff_id, :password)');
